 ...
 @FXML
  ...
  u = (Utilisateur) UserSession.INSTANCE.get("user");
    ...
    void Camping(ActionEvent event) {
        try {
            Parent root=FXMLLoader.load(getClass().getResource("ClientCamp.fxml"));
            Scene scene =new Scene(root);
       Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
        } catch (IOException ex) {
            Logger.getLogger(ClientCampController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void Randonnee(ActionEvent event) {
        try {
            Parent root=FXMLLoader.load(getClass().getResource("ClientRand.fxml"));
            Scene scene =new Scene(root);
       Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
        } catch (IOException ex) {
            Logger.getLogger(ClientRandController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
     @FXML
    ...
    @FXML
    void Participations(ActionEvent event)throws IOException {
