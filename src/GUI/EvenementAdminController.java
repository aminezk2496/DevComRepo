...
public class EvenementAdminController  implements Initializable {
    ...
    public void affiche() {
        ...
        // ObservableList<Evenement> list = new EvenementService().getEvenement();
ObservableList<Evenement> list = getEvenement();
     ...
     private void insert() throws ClassNotFoundException {
         ...
         String select = "INSERT INTO evenement (titre_event,date_debut_event,date_fin_event,prix_event,lieu_event,desc_event,image_event)VALUES(?,?,?,?,?,?,?)";
    ...
    private void update() throws ClassNotFoundException {
       // LocalDate value_date_debut_ch = date_debut_ch.getValue();
        //LocalDate value_date_fin_ch = date_fin_ch.getValue();
        String update = "UPDATE Evenement SET titre_event = ?,date_debut_event = ?,date_fin_event = ?,prix_event = ?,lieu_event = ?,desc_event = ?,image_event = ? where id_event =?";
        try {
