    ...
    public void showUsersByLog()
    {
        ...
        try {
            ...
            for (int i = 0; i < mesUtilisateurs.size(); ++i) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/Views/GestionCardUsers.fxml"));
...
}else if (u.getRankUtilisateur()==2)
{
   ...
   mesUtilisateurs.remove(u);
    ...
    public void clearData() {
        ...
        for (int x = 0; x < UserGridPane.getColumnCount(); x++) {
            for (int i = 0; i < UserGridPane.getRowCount(); i++) {
                {
