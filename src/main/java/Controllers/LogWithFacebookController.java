        ...
        eg.locationProperty().addListener((obs,oldlocation,newlocation) ->{
            if (newlocation!=null && newlocation.startsWith("http://localhost")){
             ...
             //   FacebookClient.AccessToken accessToken = facebookClient.obtainUserAccessToken (app_Id, app_Secret, "http://localhost/", code);
                String access_token ="EAAfTnLkZBt2QBAICKDXZBWnDB5fxMKnnlpkKpXzlMvdwYkXFJv2j9O3oz0sP6ebHsr6DFYf6rZAUjGGxiiQwNZAJ7rxNq66a6bIb89AA77bNthiSlf48hLQxKqqKLhreSiuWckmP5ZBP1Y3VGUNS7mp2ZAPZBlbDBCu5SGHy5d5VRzZCkoeonUfBQkpJtKYEksS8vxKY5fqZA54DSRuvoWZBvmvQi1BN27A7XswnWXVpxUzNmC9cCtta4X";
